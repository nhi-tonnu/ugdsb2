<?php
/**
 * Template Name: Student Supports Page
 *
 * This is the template that displays Library pages with STudent Supports's specific widgets
 *
 * @package ugdsb2
 */
 ?>
...
<?php $has_left = FALSE; ?>
<?php $has_right = FALSE; ?>
<?php if (has_nav_menu('lmenu') || (is_active_sidebar('sidebar-student-supports'))) {$has_left = TRUE;} ?>
...
<?php
    ...
    elseif (($has_left == TRUE) and ($has_right == FALSE)):
      ...
      //get_sidebar('lmenu');//display left menu
      if (!is_front_page()) {
          get_sidebar('student-supports');//display left menu
      }
      echo '</div>';
