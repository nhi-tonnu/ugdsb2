<?php
/**
 * Template Name: Extra Curricular Page
 *
 * This is the template that displays Extra Curricular page with Extra Curricular's specific widgets
 *
 * @package ugdsb2
 */
 ?>
...
<?php $has_left = FALSE; ?>
<?php $has_right = FALSE; ?>
<?php if (has_nav_menu('department') || (is_active_sidebar('sidebar-department'))) {$has_left = TRUE;} ?>
...
<?php
    ...
    elseif (($has_left == TRUE) and ($has_right == FALSE)):
      ...
      if (!is_front_page()) {
          get_sidebar('council');//display left menu
      }
