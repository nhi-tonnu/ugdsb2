<?php
/**
 * Template Name: Guidance Page
 *
 * This is the template that displays Guidance pages with guidances's specific widgets
 *
 * @package ugdsb2
 */
 ?>
...
<?php $has_left = FALSE; ?>
<?php $has_right = FALSE; ?>
<?php if (has_nav_menu('guidance_menu') || (is_active_sidebar('sidebar-guidance'))) {$has_left = TRUE;} ?>
...
<?php
    ...
    elseif (($has_left == TRUE) and ($has_right == FALSE)):
      ...
      get_sidebar('guidance_menu');//display left menu
      if (!is_front_page()) {
          get_sidebar('guidance');//display left menu
      }
      echo '</div>';
